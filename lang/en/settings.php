...
$lang['periodicity_keyword'] = "Keyword used to identify periodical tasks, e.g. 'repeating'.";
$lang['ssl_verifypeer']     = "Checks the SSL certifiate when connecting to Kanboard.";
$lang['cainfo']             = "When ssl_verifypeer is true, the certificate file can be defined here.";
